          ...
          <div className="col-xxl-12">
            <div className="otp1 d-flex justify-content-between align-items-center">
              ...
              <span className="d-flex align-items-center">
                <a href="index.html"> <i className="ri-home-4-fill" /> </a>
                  ...
                  <div className="recent-post-box">
                    <div className="recent-box d-flex">
                      ...
                      <div className="recent-detail">
                        ...
                        <h6 className="d-flex justify-content-between">25 Jan, 2022 <span><i className="ri-thumb-up-line" /></span>
                        </h6>
                      </div>
                    </div>
                    <div className="recent-box d-flex">
                      <a href className="image0123">
                        <img src="assets/img/15.png" className="img-fluid " alt />
                      </a>
                      <div className="recent-detail">
                        <a href>
                          <h5 className="recent-name">Green onion knife and salad placed</h5>
                    ...
                    <div className="recent-box d-flex">
                      <a href className="image0123">
                        <img src="assets/img/13.png" className="img-fluid " alt />
                      </a>
                      <div className="recent-detail">
                        <a href>
                          <h5 className="recent-name">Green onion knife and salad placed</h5>
                  ...
                  <ul className="product-list product-list-2 border-0 p-0">
                    <li>
                      <div className="offer-product d-flex">
                        <a href="#"> <img src="assets/img/23.png" alt /></a>
                    ...
                    <li>
                      <div className="offer-product d-flex">
                        <a href> <img src="assets/img/24.png" alt /></a>
                        <div className="offer-detail">
                          <div>
                            <a href="#">
                    ...
                    <li className="mb-0">
                      <div className="offer-product d-flex">
                        <a href> <img src="assets/img/25.png" alt /></a>
                        <div className="offer-detail">
                          <div>
                            <a href="#">
      ...
      <div className="col-xxl-9 col-xl-8 col-lg-7  mb-2">
        <div className="blog-grid-box mb-4 d-flex align-items-center">
          <div className="blog-image">
            <a href="#">
              <img src="assets/img/1.jpg" className="img-fluid" id="img-blog-list" />
            </a>
          </div>
          <div className="blog-content">
            <div className="blog-title d-flex flex-wrap">
              <span><i className="ri-time-line" />&nbsp;
                25 Feg, 2022</span>
              <span> <i className="ri-user-3-line" />&nbsp; Mark J. Speight</span>
            </div>
            <a href="#">
              <h3 className="text-capitalize">One Pot Creamy Mediterranean Chicken Pasta Cream.</h3>
            </a>
            <p>Monterey jack cheese slices cream cheese cream cheese hard cheese roquefort emmental
              lancashire. Who moved my cheese dolcelatte st. agur blue cheese fromage mozzarella say
              cheese mascarpone blue castello.</p>
            <button><a href="#">Read More <i className="ri-arrow-right-fill" /></a></button>
          </div>
        </div>
        <div className="blog-grid-box mb-4 d-flex align-items-center">
          <div className="blog-image">
            <a href="#">
              <img src="assets/img/5 (1).jpg" className="img-fluid" id="img-blog-list" />
            </a>
          </div>
          <div className="blog-content">
            <div className="blog-title d-flex flex-wrap">
